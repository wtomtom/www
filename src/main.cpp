...
bool GetCoinAge(const CTransaction& tx, const unsigned int nTxTime, uint64_t& nCoinAge) {
    ...
    BOOST_FOREACH(const CTxIn& txin, tx.vin) {
        ...
        LogPrintf("GetCoinAge: testetesteteste");
...
int64_t GetBlockValue(int nHeight)
{
 ...
 if (nHeight == 0) {
        ...
        nSubsidy = 1 * COIN;
    } else if (nHeight < 5 && nHeight >= 2) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= Params().LAST_POW_BLOCK() && nHeight >= 5) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 79999 && nHeight > Params().LAST_POW_BLOCK()) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 89999 && nHeight >= 80000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 94999 && nHeight >= 90000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 104999 && nHeight >= 95000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 114999 && nHeight >= 105000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 124999 && nHeight >= 115000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 134999 && nHeight >= 125000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 144999 && nHeight >= 135000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 154999 && nHeight >= 145000) {
        nSubsidy = 1 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 200 && nHeight >= 100) {
        ret = blockValue / 2;
    } else if (nHeight < 1000 && nHeight > 200) {
        ret = blockValue / 2;
